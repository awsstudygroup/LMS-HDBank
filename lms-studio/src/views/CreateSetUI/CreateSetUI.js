  ...
  const uploadConfig = async () => {
    ...
    try {
      ...
      if (banner.length > 0) {
        ...
        await Storage.put(s3KeyBanner, logo[0], {
          level: "public",
        });
      ...
      if (bannerIcon.length > 0) {
        ...
        await Storage.put(s3KeyBannerIcon, logo[0], {
          level: "public",
        });
                ...
                },
                {
                  ...
                  content: (
                    <SpaceBetween direction="vertical" size="l">
                      <Container
                        header={
                          <Header variant="h2">Left Footer</Header>
                        }
                      >
                        <SpaceBetween direction="vertical" size="l">
                          <FormField label="Information">
                            <Input
                              onChange={({ detail }) => setCurrentLeftInfo(detail.value)}
                      ...
                      <Container
                        header={
                          <Header variant="h2">Right Footer</Header>
                        }
                      >
                        <SpaceBetween direction="vertical" size="l">
                          <FormField label="Information">
                            <Input
                              onChange={({ detail }) => setCurrentRightInfo(detail.value)}
                  ...
                  content: (
                    <SpaceBetween size="l">
                      <SpaceBetween size="xs">
                        ...
                        <Container
                          header={<Header variant="h2">General config</Header>}
                        >
                          <SpaceBetween size="xs">
                            <ColumnLayout columns={2} variant="text-grid">
                              <div>
